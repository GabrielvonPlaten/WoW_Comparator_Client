  ...
  <div>
    <div class="compViews__playerOne">
      ...
      <div class="playerOne__gear" v-if="oneCheckGearState">
        <playerOneAvatar />
        <p
          class="playerItemLevel playerOneItemLevel"
        >iLvL: {{this.$store.state.playerOneGear.items.averageItemLevel}}</p>
        <ul>
          <li
            v-for="(i, index) in gearOne"
            :key="index"
          ...
          >
            <span class="item-itemLevel">
              <span class="gearslot-name">{{index}} -</span>
              {{i.itemLevel}}
            </span>
            <a
            ...
            >
              <span class="gear-name">
                {{i.name}}
                <span
                  v-if="i.name === 'Heart of Azeroth'"
                >- [{{i.azeriteItem.azeriteLevel}}]</span>
              </span>
              <img
